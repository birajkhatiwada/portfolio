...
const Terminal = (props) => {
  ...
  return (
    <div className={props.terminalAppClick ? 'terminalContainer' : 'hideForm'}>
      ...
      <div className="terminalTitleBar">Terminal -- zsh</div>
      <div className="rootNameContainer">
        <div className="rootName">portfolio@biraj $</div>
      ...
      >
        <g>
          <path
            d="M34.176,29.141c6.124-4.009,8.989-12.027,5.897-19.164c-1.959-4.52-5.764-7.752-10.502-9.061
      ...
      <div className="aboutMe">
        <div className="nameContainer">
          ...
          <div className="actualInput">: &nbsp;Biraj Khatiwada</div>
        </div>
        ...
        <div className="collegeContainer">
          ...
          <div className="actualInput">: &nbsp;Sonoma State University</div>
        </div>
        <div className="gpaContainer">
          <div className="label">GPA</div>
          <div className="actualInput">: &nbsp;3.6/4.0</div>
        </div>
        <div className="emailTerminalContainer">
          <div className="label">Email</div>
          <div className="actualInput">: &nbsp;khatiwadabiraj10@gmail.com</div>
        </div>
        <div className="linkedinTerminalContainer">
          <div className="label">Linkedin</div>
          <div className="actualInput">
            : &nbsp;www.linkedin.com/in/birajkhatiwada
          </div>
        </div>
        <div className="githubTerminalContainer">
          <div className="label">Github</div>
          <div className="actualInput">
            : &nbsp;www.github.com/birajkhatiwada
          </div>
        </div>
      </div>
    </div>
